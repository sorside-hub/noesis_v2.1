      ...
      <div className="relative w-full max-w-md h-full bg-[#131313] border-l border-[#2A2A2A] flex flex-col z-10 shadow-2xl animate-in slide-in-from-right duration-250 text-[#E5E5E5]">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          <div className="space-y-4">
            {/* PAIR 1 */}
            <div className="space-y-3 p-3.5 rounded-xl bg-[#181818] border border-[#262626]">
              <div className="flex items-center justify-between pb-1 border-b border-[#242424]">
                <h3 className="text-xs font-semibold text-[#E5E5E5] flex items-center gap-1.5">
                  <Cpu className="w-3.5 h-3.5 text-[#A3A3A3]" />
